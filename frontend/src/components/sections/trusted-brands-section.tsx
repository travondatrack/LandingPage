...
export function TrustedBrandsSection() {
  ...
  return (
    <section
      ...
      className="border-y border-line/70 bg-white py-5"
    >
        ...
        <div className="trusted-marquee-track flex w-max items-center gap-4 px-5">
          {brands.map((brand, index) => (
            <div
              ...
              className="inline-flex h-12 shrink-0 items-center gap-2.5 rounded-full border border-line bg-white px-5 text-xs font-bold tracking-widest text-ink/80 shadow-sm transition duration-300 hover:border-accent hover:text-accent hover:scale-105"
            >
